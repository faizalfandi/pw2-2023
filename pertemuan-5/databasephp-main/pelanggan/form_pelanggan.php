...
<form method="POST" action="proses_pelanggan.php">
  ...
  <div class="form-group row">
    <label for="tgl_lahir" class="col-4 col-form-label">Tanggal_lahir</label>
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
        ...
        <input id="tgl_lahir" name="tgl_lahir" value="<?php if(isset($row['tgl_lahir'])) echo $row['tgl_lahir'];?>" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
